  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col items-center justify-center px-15 py-1">
      ...
      <div className="text-center mb-5 animate-fade-in">
        <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600 mb-4">
          Mandal Expense Management
        </h1>
        <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto font-medium">
          मंडळ खर्च व्यवस्थापन प्रणाली – आपल्या मंडळाच्या आर्थिक व्यवहारांचे
          डिजिटल व्यवस्थापन.
        </p>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-6 md:p-8 max-w-4xl w-full border border-white">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="md:col-span-2 flex justify-center">
            <div className="group bg-white p-4 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 w-full md:w-1/2">
              <div className="w-10 h-10 bg-red-100 text-red-600 rounded-lg flex items-center justify-center mb-3 group-hover:bg-red-600 group-hover:text-white transition-colors">
                <FaRobot size={22} />
              </div>
              <h3 className="font-semibold text-lg mb-1 text-gray-800">
                AI Chatbot / स्मार्ट डिजिटल सहाय्यक
              </h3>
              <p className="text-sm text-gray-600">
                Ask queries and get instant assistance about expenses and reports.
                <br />
                <span className="italic text-xs">
                   खर्च, अहवाल आणि व्यवस्थापनाबाबत प्रश्न विचारा आणि त्वरित मदत मिळवा.
                </span>
              </p>
            </div>
          </div>
